...
syn keyword efType             EF_GUID EF_SessionID EF_CHARID EF_CHANNELID EF_ACCOUNTID EF_SCENEID BYTE WORD DWORD QWORD CClientAvatar CClientSession COnlineClientPool COnlineClient CZonePlayer stNullCmd CGameSceneMgr CGameSceneLoader CGameScene CAoi_Scan IAoi_Scan_Impl CAoi_Scan_Impl_Sample CAoi_Scan_Impl_ForCJ CBaseObject CMoveableObject Vector3 CGameHostCore CGameHost CZoneServerClient CZoneSvrLogic CZoneServerAPP CZoneServer2LoginServer CZoneServer2AuthServer COnlineClientMgr CAuthServerClient CAuthServerTask CPendingAuthPP 
...
hi Identifier term=bold ctermfg=5
" vim: ts=8
